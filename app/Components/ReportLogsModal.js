                      ...
                      <div className="collapse-box">
                        <div className="step-info">
                          <div className="info-row">
                            ...
                            <span className="info-i"> {!!this.props.LogsReportData[this.props.LogsReportData.length - 1].action ? this.props.LogsReportData[this.props.LogsReportData.length - 1].action : "----"}</span>
                          </div>
                          <div className="info-row">
                            <span className="info-header">Description </span>
                            <span className="info-i">  {!!this.props.LogsReportData[this.props.LogsReportData.length - 1].description ? this.props.LogsReportData[this.props.LogsReportData.length - 1].description : "----"}</span>
                          </div>
                          <div className="info-row">
                            <span className="info-header">URL </span>
                            <span className="info-i"> {!!this.props.LogsReportData[this.props.LogsReportData.length - 1].objectrepository.url ? this.props.LogsReportData[this.props.LogsReportData.length - 1].objectrepository.url : "----"}</span>
                          </div>
                          <div className="info-row">
