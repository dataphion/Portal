  ...
  class extends React.Component {
    ...
    saveRecord = async () => {
      ...
      try {
        ...
        console.log("specs id", this.props.spec_id);
        if (!this.props.spec_id) {
            ...
            <Modal.Body>
              <div className="sr-form-button-container-row" style={{ justifyContent: "center" }}>
                ...
                {/* <div
                  ...
                  className={"sr-form-button-container " + (this.state.uploadType === "postman-collection" ? "sr-form-button-bg" : "")}
                >
                  <div
                    className="fa fa-file-text"
                    style={{
                      fontSize: "20px",
                      marginRight: "15px",
                      color: this.state.uploadType === "postman-collection" ? "#fff" : "",
                    }}
                  />
                  <div className={"sr-form-button-title " + (this.state.uploadType === "postman-collection" ? "sr-form-button-title-white" : "sr-form-button-title-black")}>Create Collection</div>
                </div> */}
              </div>
